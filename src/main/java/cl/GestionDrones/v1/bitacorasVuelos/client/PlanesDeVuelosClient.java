...
public class PlanesDeVuelosClient {
    ...
    public PlanDeVueloDto obtenerPorId(Long idPlanVuelo) {
        try {
            ...
            throw new RuntimeException("El plan de vuelo con ID " + idPlanVuelo + " no existe.");
        } catch (Exception e) {
            throw new RuntimeException("No se puede conectar con el servicio de Planes de Vuelo.");
        }
    }
